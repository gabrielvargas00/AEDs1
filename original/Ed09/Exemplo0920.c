...
{  
   ...
   // identificar
      IO_id ( "Exemplo0920 - Method09 - v0.0" );
...
{  
   ...
   // identificar
      IO_id ( "Exemplo0920 - Method10 - v0.0" );
...
{   
   ...
   // identificar
      IO_id ( "Exemplo0920 - Method11 - v0.0" );
...
void method13 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0920 - Method13 - v0.0" );
...
void method14 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0920 - Method14 - v0.0" );
...
/**
 printLDTriangleDoubleMatrix - Mostrar valores abaixo e na diagonal principal da matriz.
 @param rows                 - quantidade de linhas
 @param columns              - quantidade de colunas
 @param matrix               - grupo de valores inteiros
*/
...
void printLDTriangleDoubleMatrix ( int rows, int columns, double matrix[ ][columns] )
{
   ...
   // testar se matriz e' quadrada
      if ( rows == columns )
      {
        IO_printf ( "\nElementos triangulo inferior + diag principal:\n" );
        // mostrar valores na matriz
            for ( x=0; x<rows; x=x+1 )
            {
                for ( y=0; y<columns; y=y+1 )
...
/**
 Method15 - mostrar valores abaixo e na diagonal principal da matriz
 */
...
void method15 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0920 - Method15 - v0.0" );
   ...
   // mostrar dados
      ...
      printDoubleMatrix           ( x, y, matrix );
      printLDTriangleDoubleMatrix ( x, y, matrix );
...
/**
 printLUTriangleDoubleMatrix - Mostrar valores abaixo e na diagonal principal da matriz.
 @param rows                 - quantidade de linhas
 @param columns              - quantidade de colunas
 @param matrix               - grupo de valores inteiros
*/
...
void printLUTriangleDoubleMatrix ( int rows, int columns, double matrix[ ][columns] )
{
   ...
   // testar se matriz e' quadrada
      if ( rows == columns )
      {
        IO_printf ( "\nElementos triangulo superior + diag principal:\n" );
        // mostrar valores na matriz
            for ( x=0; x<rows; x=x+1 )
            {
                for ( y=0; y<columns; y=y+1 )
...
} // end printLUTriangleDoubleMatrix ( )

/**
 Method16 - mostrar valores acima e na diagonal principal da matriz
 */
...
void method16 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0920 - Method16 - v0.0" );
   ...
   // mostrar dados
      ...
      printDoubleMatrix           ( x, y, matrix );
      printLUTriangleDoubleMatrix ( x, y, matrix );
...
/**
 printSLDTriangleDoubleMatrix - Mostrar valores abaixo e na diagonal principal da matriz.
 @param rows                  - quantidade de linhas
 @param columns               - quantidade de colunas
 @param matrix                - grupo de valores inteiros
*/
...
void printSLDTriangleDoubleMatrix ( int rows, int columns, double matrix[ ][columns] )
{
   ...
   // testar se matriz e' quadrada
      if ( rows == columns )
      {
        IO_printf ( "\nElementos triangulo inferior secundario + diag secundaria:\n" );
        // mostrar valores na matriz
            for ( x=0; x<rows; x=x+1 )
            {
                for ( y=0; y<columns; y=y+1 )
...
/**
 Method17 - mostrar valores abaixo e na diagonal secundaria da matriz
 */
...
void method17 ( )
{
   ...
   // mostrar dados
      ...
      printDoubleMatrix            ( x, y, matrix );
      printSLDTriangleDoubleMatrix ( x, y, matrix );
...
/**
 printSLUTriangleDoubleMatrix - Mostrar valores acima e na diagonal principal da matriz.
 @param rows                  - quantidade de linhas
 @param columns               - quantidade de colunas
 @param matrix                - grupo de valores inteiros
*/
...
void printSLUTriangleDoubleMatrix ( int rows, int columns, double matrix[ ][columns] )
{
   ...
   // testar se matriz e' quadrada
      if ( rows == columns )
      {
        IO_printf ( "\nElementos triangulo superior secundario + diag secundaria:\n" );
        // mostrar valores na matriz
            for ( x=0; x<rows; x=x+1 )
            {
                for ( y=0; y<columns; y=y+1 )
...
/**
 Method18 - mostrar valores acima e na diagonal secundaria da matriz
 */
...
void method18 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0920 - Method17 - v0.0" );
   ...
   // mostrar dados
      ...
      printDoubleMatrix            ( x, y, matrix );
      printSLUTriangleDoubleMatrix ( x, y, matrix );
...
/**
 allZerosLTriangleDoubleMatrix - testar se triangulo inferior e' nulo.
...
/**
 readDoubleMatrix - ler tamanho de matriz e, nela,
                            guardar valores reais positivos
 @param rows              - quantidade de linhas
 @param columns           - quantidade de colunas
 @param matrix            - grupo de valores inteiros
...
/**
 Method19 - testar se triangulo inferior e' nulo
 */
...
void method19 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0920 - Method19 - v0.0" );
   ...
   // ler matriz
      readDoubleMatrix ( x, y, matrix );

   // mostrar dados
      IO_printf ( "\nMatriz lida:\n" );

      printDoubleMatrix                      ( x, y, matrix );
      result = allZerosLTriangleDoubleMatrix ( x, y, matrix );

      if ( result == true )
      {
          IO_printf ( "\nOs elementos do triangulo inferior sao zeros" );
      } // end if
      else IO_printf ( "\nOs elementos do triangulo inferior sao diferentes de zeros" );
...
/**
 allZerosUTriangleDoubleMatrix - testar se triangulo superior e' nulo.
 @return        - true, se todos forem iguais a zero;
                  false, caso contrario
 @param rows    - quantidade de valores
 @param columns - quantidade de valores
...
/**
 Method20 - testar se triangulo superior e' nulo
 */
...
void method20 ( )
{
   ...
   // mostrar dados
      ...
      printDoubleMatrix                      ( x, y, matrix );
      result = allZerosUTriangleDoubleMatrix ( x, y, matrix );

      if ( result == true )
      {
          IO_printf ( "\nOs elementos do triangulo superior sao zeros" );
      } // end if
      else IO_printf ( "\nOs elementos do triangulo superior sao diferentes de zeros" );
...
{
    // identificar
       IO_id ( "Exemplo0920 - MethodE1 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0920 - MethodE2 - v0.0" );
...
int main ( )
{
    ...
    // repetir ate desejar parar
       ...
       {
            // identificar
               IO_id ( "Exemplo0920 - Programa - v0.0" );
            ...
            // ler do teclado
               ...
               IO_println ( "15 - mostrar valores abaixo e na diagonal principal  da matriz" );
               IO_println ( "16 - mostrar valores acima  e na diagonal principal  da matriz" );
               IO_println ( "17 - mostrar valores abaixo e na diagonal secundaria da matriz" );
               IO_println ( "18 - mostrar valores acima  e na diagonal secundaria da matriz" );
               IO_println ( "19 - testar se triangulo inferior e' nulo                     " );
               IO_println ( "20 - testar se triangulo superior e' nulo                     " );
               // IO_println ( "21 - " );
               // IO_println ( "22 - " );
               IO_println ( " " );
