         ...
         // executar a opcao de comando
            switch ( option )
            {
                ...
                case 12: // fazer curva fechada 'a direita ("U")
                        ...
                        break;
/**
                case 13: // andar metado do caminho para a direita
                        while (!facingEast())
                        {
                            turnLeft();
                        } // end while
                ...
                case 14: // andar metado do caminho para a esquerda
                        while (!facingWest())
                        {
                            turnLeft();
                        } // end while
...
*/
     ...
     */
     ...
     /**
      recordBeepers - Metodo para guardar a coordenada
      dos marcadores tarefa em um arquivo.
      @param fileName - nome do arquivo
      */
     void recordBeepers ( const char *fileName )
     {
         // definir dados
            int action;
            int x;
     ...
     /**
      recordMove - Metodo para guardar o percurso do robo em arquivo.
      @param fileName - nome do arquivo
      */
     void recordMove ( const char *fileName )
     {
         // definir dados
            int action;
            int x;
         ...
         // repetir enquanto acao maior que zero
            while ( action > 0 )
            {
                // testar se robo se moveu
                   if ( action != 5 )
                   {
                        // executar comando
                           execute (action);
...
/**              case 13: // andar metado do caminho para a direita
              strcpy ( word, "halfPathRight(); " );
              break;

              case 14: // andar metado do caminho para a esquerda
              strcpy ( word, "halfPathLeft(); " );
              break;
*/
           } // end switch
 ...
 void readMap ( const char * fileName )
 {
    ...
    /**
     testRobot - Metodo para testar se proximo a outro robo 
     */
    void testRobot( )
    {
        // especificacoes do metodo
    ...
    /**
     testBeeper - Metodo para testar se proximo a um marcador 
     */
    void testBeeper( )
    {
        // especificacoes do metodo
    ...
    /**
     doTaskA - Jarel: buscar marcador ate a passagem
     */
    void doTaskA( )
    {
        // especificacoes do metodo
    ...
    /**
     doTaskB - Jarel: ir ao ponto de entrega, mas, caso Karel nao estiver,
               retornar 'a posicao inicial
     */
    void doTaskB( )
    {
    ...
    /**
     doTaskC - Karel: ir ao ponto de entrega e tentar pegar marcador
     */
    void doTaskC( )
    {
        // especificacoes do metodo
    ...
    /**
     doTaskD - Jarel: ir novamente ao ponto de entrega, mas, 
               caso Karel nao estiver, retornar 'a posicao inicial
     */
    void doTaskD( )
    {
        // especificacoes do metodo
    ...
    /**
     doTaskE - Karel: tentar pegar marcador
     */
    void doTaskE( )
    {
        // especificacoes do metodo
    ...
    /**
     doTaskF - Jarel: ir para a sua posicao final
     */
    void doTaskF( )
    {
        // especificacoes do metodo
    ...
    /**
     doTaskG - Karel: levar marcador para posicao final
               e, depois, ir para a sua posicao final tambem
     */
    void doTaskG( )
    {
        // especificacoes do metodo
    ...
    /**
     doTaskH - Karel: retornar 'a sua posiciao inicial
     */
    void doTaskH( )
    {
        // especificacoes do metodo
    ...
    /**
     doTaskI - Jarel: retornar 'a sua posiciao inicial
     */
    void doTaskI( )
    {
        // especificacoes do metodo
...
int main()
{
    ...
    // posicao (x=1, y=1), voltado para direita, com zero marcadores, nome escolhido
       robot1->create ( 8, 6, WEST, 0, "Jarel" ); //"J"
       robot2->create ( 8, 5, WEST, 0, "Karel" ); //"K"
