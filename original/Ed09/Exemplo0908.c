...
void method01 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0908 - Method01 - v0.0" );
...
void method02 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0908 - Method02 - v0.0" );
...
{  
   ...
   // identificar
      IO_id ( "Exemplo0908 - Method03 - v0.0" );
...
void method04 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0908 - Method04 - v0.0" );
...
{  
   ...
   // identificar
      IO_id ( "Exemplo0908 - Method05 - v0.0" );
...
{  
    // definir dados
       ...
       int matrix4 [ ][3] = { {1, 2, 3} ,
                              ...
                              {7, 8, 9} };
   // identificar
      IO_id ( "Exemplo0908 - Method06 - v0.0" );
...
{  
   ...
   // identificar
      IO_id ( "Exemplo0908 - Method07 - v0.0" );
...
{  
   // identificar
      IO_id ( "Exemplo0908 - Method09 - v0.0" );
...
{  
   // identificar
      IO_id ( "Exemplo0908 - Method10 - v0.0" );
...
int main ( )
{
    ...
    // repetir ate desejar parar
       ...
       {
            // identificar
               IO_id ( "Exemplo0908 - Programa - v0.0" );
