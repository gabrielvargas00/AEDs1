...
/**
  MethodE2 - Inverter ordem simbolos na cadeia de caracteres
*/
...
void methodE2 ( )
{
   // definir dado
      MyString conteudo1 ( ""           );
      MyString conteudo2 ( "ABCDEF"     );
      MyString conteudo3 ( "ODITREVNI"  );
      MyString conteudo4 ( "123abc   "  );
      MyString conteudo5 ( "A"          );
      
   // identificar
      cout << "\nExemplo14E2 - MethodE2 - v0.0\n" << endl;
   
   // converter conteudo
      cout << "\nInverter ( "    << conteudo1.getConteudo( ) << " ) = ";
      conteudo1.invert ( ); cout << conteudo1.getConteudo( );
      conteudo1.printError ( conteudo1.getErro( ) );

      cout << "\nInverter ( "    << conteudo2.getConteudo( ) << " ) = ";
      conteudo2.invert ( ); cout << conteudo2.getConteudo( );
      conteudo2.printError ( conteudo2.getErro( ) );

      cout << "\nInverter ( "    << conteudo3.getConteudo( ) << " ) = ";
      conteudo3.invert ( ); cout << conteudo3.getConteudo( );
      conteudo3.printError ( conteudo3.getErro( ) );

      cout << "\nInverter ( "    << conteudo4.getConteudo( ) << " ) = ";
      conteudo4.invert ( ); cout << conteudo4.getConteudo( );
      conteudo4.printError ( conteudo4.getErro( ) );

      cout << "\nInverter ( "    << conteudo5.getConteudo( ) << " ) = ";
      conteudo5.invert ( ); cout << conteudo5.getConteudo( );
      conteudo5.printError ( conteudo5.getErro( ) );
    ...
    // repetir ate desejar parar
       do
       {
            ...
            // mostrar opcoes
               ...
               cout << "12 - inverter ordem simbolos                " << endl;
...
Inverter ( ABCDEF ) = FEDCBA

Inverter ( ODITREVNI ) = INVERTIDO

Inverter ( 123abc    ) =    cba321
