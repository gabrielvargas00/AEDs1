...
{
    // identificar
       IO_id ( "EXEMPLO0604 - Method01 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0604 - Method02 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0604 - Method03 - v0.0" );
...
* embora resultado incorreto, ele e' esperado, pois esta' escrito que, caso o x nao entre com um valor positivo,
  devera' mostrar na tela "valor = 1", partindo do pressuposto de que o primeiro valor seria o 1.
 ----------------------------- historico
