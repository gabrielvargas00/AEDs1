...
{
    // identificar
       IO_id ( "EXEMPLO0606 - Method01 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0606 - Method02 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0606 - Method03 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0606 - Method04 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0606 - Method05 - v0.0" );
...
/**
 Method06 - calcular o somatorio: 1 + 2/3 + 4/5 + 6/7 + ...
 */
...
* embora resultado incorreto, ele e' esperado, pois esta' escrito que, caso o x nao entre com um valor positivo,
  devera' mostrar na tela como 1.000000, partindo do pressuposto de que o primeiro valor seria o 1.
 ----------------------------- historico
...
0.6            01.(OK)       calcular o somatorio: 1 + 2/3 + 4/5 + 6/7 + ...
