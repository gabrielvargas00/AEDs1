...
{  
   // identificar
      cout << endl << "Exemplo1406 - Method08 - v0.0" << endl;
...
{  
   // identificar
      cout << endl << "Exemplo1406 - Method09 - v0.0" << endl;
...
{  
   // identificar
      cout << endl << "Exemplo1406 - Method10 - v0.0" << endl;
...
Trocar r por l ( Arara ) = Alala

Trocar e por i ( teste ) = tisti

Trocar a por 4 ( PaLaVRa ) = P4L4VR4

Trocar 0 por 1 ( 123!@#abcDEF ) = 123!@#abcDEF
[ERRO] Caractere nao encontrado


Trocar C por c ( 1a2b3C ) = 1a2b3c
