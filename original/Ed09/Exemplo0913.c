...
void method01 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0913 - Method01 - v0.0" );
...
void method02 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0913 - Method02 - v0.0" );
...
{  
   ...
   // identificar
      IO_id ( "Exemplo0913 - Method03 - v0.0" );
...
void method04 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0913 - Method04 - v0.0" );
...
{  
   ...
   // identificar
      IO_id ( "Exemplo0913 - Method05 - v0.0" );
...
{  
    // definir dados
       ...
       int matrix4 [ ][3] = { {1, 2, 3} ,
                              ...
                              {7, 8, 9} };
   // identificar
      IO_id ( "Exemplo0913 - Method06 - v0.0" );
...
{  
   ...
   // identificar
      IO_id ( "Exemplo0913 - Method07 - v0.0" );
...
{  
   ...
   // identificar
      IO_id ( "Exemplo0913 - Method08 - v0.0" );
...
{  
   ...
   // identificar
      IO_id ( "Exemplo0913 - Method09 - v0.0" );
...
{  
   ...
   // identificar
      IO_id ( "Exemplo0913 - Method10 - v0.0" );
...
{   
   ...
   // identificar
      IO_id ( "Exemplo0913 - Method11 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0913 - Method14 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0913 - Method15 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0913 - Method16 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0913 - Method17 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0913 - Method18 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0913 - Method19 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0913 - Method20 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0913 - MethodE1 - v0.0" );
...
{
    // identificar
       IO_id ( "Exemplo0913 - MethodE2 - v0.0" );
...
int main ( )
{
    ...
    // repetir ate desejar parar
       ...
       {
            // identificar
               IO_id ( "Exemplo0913 - Programa - v0.0" );
