...
void method01 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo1008 - Method01 - v0.0" );
...
void method02 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo1008 - Method02 - v0.0" );
...
{  
   ...
   // identificar
      IO_id ( "Exemplo1008 - Method03 - v0.0" );
...
{  
   ...
   // identificar
      IO_id ( "Exemplo1008 - Method04 - v0.0" );
...
{  
   ...
   // identificar
      IO_id ( "Exemplo1008 - Method05 - v0.0" );
...
{  
   ...
   // identificar
      IO_id ( "Exemplo1008 - Method06 - v0.0" );
...
{  
   ...
   // identificar
      IO_id ( "Exemplo1008 - Method07 - v0.0" );
...
{  
   ...
   // identificar
      IO_id ( "Exemplo1008 - Method08 - v0.0" );
...
{  
   // identificar
      IO_id ( "Exemplo1008 - Method09 - v0.0" );
...
{  
   // identificar
      IO_id ( "Exemplo1008 - Method10 - v0.0" );
...
Ler dimensoes de matriz validas: 3x3 ( rows > 0 && columns > 0)
...
Gravar matriz lida em MATRIX1.TXT
3
3
1
2
