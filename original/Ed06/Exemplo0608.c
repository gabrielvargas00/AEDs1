...
{
    // identificar
       IO_id ( "EXEMPLO0608 - Method01 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0608 - Method02 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0608 - Method03 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0608 - Method04 - v0.0" );
...
{  
    // identificar
       IO_id ( "Exemplo0608 - Method05 - v0.0" );
...
{ 
    ...
    // identificar
       IO_id ( "Exemplo0608 - Method06 - v0.0" );
...
{  
    ...
    // identificar
       IO_id ( "Exemplo0608 - Method07 - v0.0" );
...
Ha' espaco reservado para 3 digitos, e, por isso, os numeros entre parenteses estarao alinhados

CORRECAO DA PREVISAO:

digitos (  1) = 1

Estava errado ao considerar o alinhamnto 'a esquerda, quando, na verdade, os espacos vazios que estao 'a esquerda
