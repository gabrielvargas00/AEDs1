...
class MyRobot : public Robot
{
    ...
    /** markBeepers - Metodo para acrescentar posicao dos marcadores ao arquivo
    ...
    void markBeepers ( const char *fileName )
     {
         ...
         // definir arquivo para receber acrescimos ao final
            std::fstream archive ( fileName );

            while (nextToABeeper())
            {
               // se robo pegar marcadores
                  if (pickBeepers())
                  {
                     // obter coordenadas
                        x = xAvenue();      // obter posicao atual (Avenue)
                        y = yStreet();      // obter posicao atual (Street)
                     // guardar coordenada em um arquivo
                        archive << x << std::endl;
                        archive << y << std::endl;
                  } // end if
            } // end while ()
