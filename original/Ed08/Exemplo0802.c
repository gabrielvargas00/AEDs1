...
void method01 ( )
{
   ...
   // identificar
      IO_id ( "Exemplo0802 - Method01 - v0.0" );
...
{  
   // identificar
      IO_id ( "Exemplo0802 - Method03 - v0.0" );
...
{  
   // identificar
      IO_id ( "Exemplo0802 - Method04 - v0.0" );
...
{  
   // identificar
      IO_id ( "Exemplo0802 - Method05 - v0.0" );
...
{  
   // identificar
      IO_id ( "Exemplo0802 - Method06 - v0.0" );
...
{  
   // identificar
      IO_id ( "Exemplo0802 - Method07 - v0.0" );
...
{  
   // identificar
      IO_id ( "Exemplo0802 - Method08 - v0.0" );
...
{  
   // identificar
      IO_id ( "Exemplo0802 - Method09 - v0.0" );
...
{  
   // identificar
      IO_id ( "Exemplo0802 - Method10 - v0.0" );
...
int main ( )
{
    ...
    // repetir ate desejar parar
       ...
       {
            // identificar
               IO_id ( "Exemplo0802 - Programa - v0.0" );
