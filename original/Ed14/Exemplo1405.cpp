...
{  
   // identificar
      cout << endl << "Exemplo1405 - Method06 - v0.0" << endl;
...
{  
   // identificar
      cout << endl << "Exemplo1405 - Method07 - v0.0" << endl;
...
{  
   // identificar
      cout << endl << "Exemplo1405 - Method08 - v0.0" << endl;
...
{  
   // identificar
      cout << endl << "Exemplo1405 - Method09 - v0.0" << endl;
...
{  
   // identificar
      cout << endl << "Exemplo1405 - Method10 - v0.0" << endl;
...
Em letras maiusculas ( TESTE ) = TESTE

Em letras maiusculas ( teste ) = TESTE

Em letras maiusculas ( PaLaVrA ) = PALAVRA

Em letras maiusculas ( 123!@#abcDEF ) = 123!@#ABCDEF

Em letras maiusculas ( 1a2b3c ) = 1A2B3C
...
Versao       Teste
0.5          01.(OK)           converter para maiuscula
