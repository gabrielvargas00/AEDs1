...
{  
   // identificar
      cout << endl << "Exemplo1406 - Method07 - v0.0" << endl;
...
Em letras minusculas ( TESTE ) = teste

Em letras minusculas ( teste ) = teste

Em letras minusculas ( PaLaVrA ) = palavra

Em letras minusculas ( 123!@#abcDEF ) = 123!@#abcdef

Em letras minusculas ( 1a2b3C ) = 1a2b3c
...
Versao       Teste
0.6          01.(OK)           converter para minuscula
