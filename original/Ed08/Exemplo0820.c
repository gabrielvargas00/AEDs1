...
/**
 acharQuantos - Procurar quantidade de certo valor em arranjo com inteiros.
 @return      - quantidade de repeticoes do valor
 @param value - valor a ser procurado
 @param start - posicao a se iniciar a busca
 @param n     - quantidade de valores
 @param array - grupo de valores inteiros
...
int acharQuantos ( int value, int start, int n, int array [ ] )
{
    // definir dados locais
       int  vezes = 0;;
...
/**
 Method20 - ler arranjo de arquivo e dizer quantas vezes um valor aparece
 */
   ...
   // ler dados
      ...
      else
      {
          ...
          // ler dados
             freadIntArray       ( "DADOS.TXT", n, array );
          // obter quantidade
             IO_printf ( "\nA quantidade de vezes que o valor %d se encontra no arranjo e' = %d.\n", 
                                    procurado, acharQuantos ( procurado, 0, n, array ) );
      } // end else
    ...
    // repetir ate desejar parar
       do
       {
            ...
            // ler do teclado
               ...
               IO_println ( "20 - ler arranjo de arquivo e dizer quantas vezes um valor aparece " );
               // IO_println ( "21 - " );
               // IO_println ( "22 - " );
               IO_println ( " " );
...
A quantidade de vezes que o valor 41 se encontra no arranjo e' = 1.


Valor a ser procurado: 100

A quantidade de vezes que o valor 100 se encontra no arranjo e' = 0.


Valor a ser procurado: 64

A quantidade de vezes que o valor 64 se encontra no arranjo e' = 1.


Valor a ser procurado: -1

A quantidade de vezes que o valor -1 se encontra no arranjo e' = 0.


Valor a ser procurado: 22

A quantidade de vezes que o valor 22 se encontra no arranjo e' = 1.

----------------------------------------------------------------------

Ler arquivo TESTE3.TXT e procurar valor vindo do teclado

Valor a ser procurado: 41

A quantidade de vezes que o valor 41 se encontra no arranjo e' = 4.


Valor a ser procurado: 85

A quantidade de vezes que o valor 85 se encontra no arranjo e' = 3.


Valor a ser procurado: 72

A quantidade de vezes que o valor 72 se encontra no arranjo e' = 1.

Valor a ser procurado: 25

A quantidade de vezes que o valor 25 se encontra no arranjo e' = 0.
