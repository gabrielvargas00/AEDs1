...
class Contact: public Erro
{
     ...
     */
    Contact ( std::string nome_inicial, std::string fone1_inicial, std::string fone2_inicial )
    {
        // tratamento de erro
           setErro ( 0 );  // nenhum erro ainda
...
using ref_Contact = Contact*; // similar a typedef Contact* ref_Contact
