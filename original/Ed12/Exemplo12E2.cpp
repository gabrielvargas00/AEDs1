...
void method02 ( )
{
   ...
   // identificar
      cout << endl << "Exemplo12E2 - Method02 - v0.0" << endl;
...
{  
   ...
   // identificar
      cout << endl << "Exemplo12E2 - Method03 - v0.0" << endl;
...
{  
   ...
   // identificar
      cout << endl << "Exemplo12E2 - Method04 - v0.0" << endl;
...
{  
   ...
   // identificar
      cout << endl << "Exemplo12E2 - Method05 - v0.0" << endl;
...
{  
   ...
   // identificar
      cout << endl << "Exemplo12E2 - Method06 - v0.0" << endl;
...
{  
   ...
   // identificar
      cout << endl << "Exemplo12E2 - Method07 - v0.0" << endl;
...
{  
   ...
   // identificar
      cout << endl << "Exemplo12E2 - Method08 - v0.0" << endl;
...
{  
   ...
   // identificar
      cout << endl << "Exemplo12E2 - Method09 - v0.0" << endl;
...
{  
   ...
   // identificar
      cout << endl << "Exemplo12E2 - Method11 - v0.0" << endl;
...
{  
   ...
   // identificar
      cout << endl << "Exemplo12E2 - Method12 - v0.0" << endl;
...
{  
   ...
   // identificar
      cout << endl << "Exemplo12E2 - Method13 - v0.0" << endl;
...
{  
   ...
   // identificar
      cout << endl << "Exemplo12E2 - Method14 - v0.0" << endl;
...
{  
   ...
   // identificar
      cout << endl << "Exemplo12E2 - Method15 - v0.0" << endl;
...
/**
  Method16 - Operar duas colunas de matriz, somando
 */
...
{  
   ...
   // identificar
      cout << endl << "Exemplo12E2 - Method16 - v0.0" << endl;
   ...
   // operar matrix
      matrix = matrix.somarLinhas ( 0, 1, (-1) );

   // mostrar dados
      cout << endl << "Alterada" << endl;
      matrix.print ( );
...
/**
  Method17 - Operar duas colunas de matriz, subtraindo
 */
...
{  
   ...
   // identificar
      cout << endl << "Exemplo12E2 - Method17 - v0.0" << endl;
   ...
   // operar matrix
      matrix = matrix.subtrairLinhas ( 0, 1, (2) );
...
/**
  Method18 - Procurar linha em que valor se encontra
           - retorna (-1 ) caso nao encontrado
           - mostra a linha em que valor aparece pela primeira vez apenas
 */
...
{  
   ...
   // identificar
      cout << endl << "Exemplo12E2 - Method18 - v0.0" << endl;
   ...
   // procurar valores
      cout << "(41) Linha = " << matrix.procurarLinhas ( 41 ) << endl;
      cout << "(80) Linha = " << matrix.procurarLinhas ( 80 ) << endl;
      cout << "(49) Linha = " << matrix.procurarLinhas ( 49 ) << endl;
      cout << "(87) Linha = " << matrix.procurarLinhas ( 87 ) << endl;
      cout << "(20) Linha = " << matrix.procurarLinhas ( 20 ) << endl; //nao ha
...
/**
  Method19 - Procurar coluna em que valor se encontra
           - retorna (-1 ) caso nao encontrado
           - mostra a coluna em que valor aparece pela primeira vez apenas
 */
...
{  
   ...
   // identificar
      cout << endl << "Exemplo12E2 - Method19 - v0.0" << endl;
   ...
   // procurar valores
      cout << "(41) Coluna = " << matrix.procurarColunas ( 41 ) << endl;
      cout << "(80) Coluna = " << matrix.procurarColunas ( 80 ) << endl;
      cout << "(49) Coluna = " << matrix.procurarColunas ( 49 ) << endl;
      cout << "(87) Coluna = " << matrix.procurarColunas ( 87 ) << endl;
      cout << "(20) Coluna = " << matrix.procurarColunas ( 20 ) << endl; //nao ha
...
/**
  Method20 - Obter matriz transposta
 */
...
{  
   ...
   // identificar
      cout << endl << "Exemplo12E2 - Method20 - v0.0" << endl;
...
/**
 MethodE1 - Testar se linha das matrizes possuem valores crescentes:
            1 2 3
            4 5 6
            7 8 9
 */
...
{  
   ...
   // identificar
      cout << endl << "Exemplo12E2 - MethodE1 - v0.0" << endl;
   
   // ler matriz
      matrix1.fread ( "DADOS.TXT"        );
      matrix2.fread ( "MATRIX_LINHA.TXT" );
   ...
   // mostrar teste
      cout << "Linhas crescentes = " << matrix1.linhaCrescente ( ) << endl;
   ...
   // mostrar teste
      cout << "Linhas crescentes = " << matrix2.linhaCrescente ( ) << endl;
...
/**
 MethodE2 - Testar se coluna das matrizes possuem valores crescentes:
            1  4  7
            2  5  8
            3  6  9
 */
...
{  
   ...
   // identificar
      cout << endl << "Exemplo12E2 - MethodE2 - v0.0" << endl;
   
   // ler matriz
      matrix1.fread ( "DADOS.TXT"        );
      matrix2.fread ( "MATRIX_COLUNA.TXT" );
   ...
   // mostrar teste
      cout << "Colunas crescentes = " << matrix1.colunaCrescente ( ) << endl;
   ...
   // mostrar teste
      cout << "Colunas crescentes = " << matrix2.colunaCrescente ( ) << endl;
    ...
    // repetir ate desejar parar
       do
       {
            ...
            // mostrar opcoes
               ...
               cout << "16 - operar duas colunas de matriz, somando    " << endl;
               cout << "17 - operar duas colunas de matriz, subtraindo " << endl;
               cout << "18 - procurar linha em que certo valor esta'   " << endl;
               cout << "19 - procurar coluna em que certo valor esta'  " << endl;
               cout << "20 - obter matriz transposta                   " << endl;
               cout << "21 - testar se linhas da matriz sao crecentes  " << endl;
               cout << "22 - testar se colunas da matriz sao crecentes " << endl;
